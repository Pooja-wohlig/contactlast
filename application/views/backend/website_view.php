<div class="row" style="padding:1% 0">
	<div class="col-md-12">
		<div class="pull-right">
			<a href="<?php echo site_url('contactus1/website_insert'); ?>" class="btn btn-primary pull-right"><i class="icon-long-arrow-left"></i>&nbsp;Back</a>
		</div>
	</div>
</div>
<div class="row">
	<div class="col-lg-12">
	    <section class="panel">
			...
			<div class="panel-body">
			  <form class="form-horizontal tasi-form" class="table table-bordered" method="post" action="<?php echo site_url('contactus1/website_insertsubmit');?>" enctype= "multipart/form-data">
				...
				<div class=" form-group">
				  ...
				  <div class="col-sm-4">
					<input type="json" id="description-field" class="form-control" name="json" value="">
				  </div>
				</div>
				<div class=" form-group">
				  <label class="col-sm-2 control-label" for="description-field">IP</label>
				  <div class="col-sm-4">
					<input type="text" id="description-field" class="form-control" name="ip" value="">
				  </div>
				</div>
				<div class=" form-group">
				  <label class="col-sm-2 control-label" for="description-field">Website</label>
				  <div class="col-sm-4">
					<input type="text" id="description-field" class="form-control" name="website" value="">
				  </div>
				</div>
<!--
				<div class=" form-group">
...
-->
				<div class=" form-group">
				  ...
				  <a href="<?php echo site_url('contactus1/website_insert'); ?>" class="btn btn-secondary">Cancel</a>
				</div>
				</div>	
			  </form>
			</div>
